...
class TenantAwareSupabase:
    ...
    def __init__(self, base: Client) -> None:
        ...
        # PERFORMANCE FIX: Add connection timeout and cleanup tracking
    ...
    def table(self, name: str):
        ...
        # PERFORMANCE FIX: Proactive connection cleanup
...
try:
    if settings.supabase_url and settings.supabase_service_role_key:
        ...
        # Challenge Mode: Supabase client is not available
        ...
        class ChallengeAuth:
            def get_user(self, token):
                ...
                try:
                    # In a real app we would verify signature, but here we just need payload
                    # because we are in mock mode
                    import jwt
